...
public class UnitDefinitionGui : MonoBehaviour
{
    public interface IGameRule
    {
        ...
        float GetRemainCoolTime(UnitDefinitionGui unitDefinitionGui);
    }
    public readonly GameRuleManager<IGameRule> RuleManager = new GameRuleManager<IGameRule>();
    ...
    IEnumerator UpdateCoolTimeDisplay()
    {
        ...
        SetRemainCoolTime((RuleManager.Rule?.GetRemainCoolTime(this) ?? 0f));
        while ((RuleManager.Rule?.GetRemainCoolTime(this) ?? 0f) != 0)
        {
